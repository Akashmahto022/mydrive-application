            ...
            <AlertDialogContent className="shad-alert-dialog">
                <AlertDialogHeader className="relative flex justify-center">
                    ...
                    <AlertDialogDescription className='subtitle-2 text-center text-light-100'>
                        We've sent the OTP to <span className='pl-1 text-brand'>{email}</span>
                    </AlertDialogDescription>
                </AlertDialogHeader>
                ...
                <AlertDialogFooter>
                    <div className='flex w-full flex-col gap-4'>
                        <AlertDialogAction onClick={onSubmit} className='shad-submit-btn' type='button'>
                            Submit
                            {isLoading && (
                        ...
                        <div className='subtitle-2 mt-2 text-center text-light-100'>Didn't get a code?
                            <Button type="button" variant={"link"} className='pl-1 text-brand' onClick={handleResendOTP}>Click to send</Button>
                        </div>
                    </div>
                </AlertDialogFooter>
            </AlertDialogContent>
